...
> 一个小型私人文件服务器，利用ESP32的WiFi热点或接入局域网，轻松访问内存卡中的文件或在线播放视频。

项目实现文件上传下载、播放视频、模式转换（AP STA AP+STA互相转换）等功能，代码由ESP32 Arduino core框架编写。
...
- **模式转换（WiFi配网）** -- 服务器默认为AP模式，可通过网页让服务器连接WiFi接入局域网，然后通过局域网访问服务器
- **OLED屏显示** -- 显示服务器状态、IP地址、时钟等

![image](/assets/ESP32-S3服务器硬件.jpg)

![image](/assets/ESP32-ESP32-S3服务器主页.jpg)
